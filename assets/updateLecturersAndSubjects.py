...
newNames = {'subjects': set(), 'lecturers': set()}
...
def writeLog():
    ...
    with open('../_data/autoGenerated/newLecturers.yml', 'w+') as f:
        for name in newNames['lecturers']:
            print('- "' + name + '"', file=f)
    with open('../_data/autoGenerated/newSubjects.yml', 'w+') as f:
        for name in newNames['subjects']:
            print('- "' + name + '"', file=f)
